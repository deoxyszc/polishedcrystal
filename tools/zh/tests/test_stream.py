...
cases += [(f'byte-{b:02x}',f'{b:02x}',1,4,b if (b in [2,0x52,0x53,0x54,0x55,0x56,0x57,0x59] or 0x7f<=b<0xf2) else None) for b in [0,1,2,3,4,8,9,0x4f,0x52,0x53,0x54,0x55,0x56,0x57,0x58,0x59,0x5a,0x5d,0x7f,0x80,0xf1,0xf2,0xff]]
