...
cases=[(0,bytes.fromhex('808153'),True),(1,bytes.fromhex('828353'),True),(0,b'\x53',True),(0,b'\x80'*10+b'\x53',True),(0,b'\x80'*11,False),(0,bytes.fromhex('800a53'),False),(0,bytes.fromhex('800153'),False),(0,bytes.fromhex('805d53'),False),(0,bytes.fromhex('80f253'),False),(2,b'\x53',False)]
...
'''.replace('SOURCE',str(source))
  ...
  else:assert buf==b'\xaa'*12,(index,buf.hex())
print('PASS 10 real CPU cases: player/rival, max/empty, unterminated/control/E1 rejects, atomic output, WRAM bank restore')
