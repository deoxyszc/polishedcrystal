ZhSummaryLabels::
 ...
 hlbgcoord 5,6,wSummaryScreenWindowBuffer
 call .digit
 call ZhCenterSummaryStats
 call ZhSummaryBottomBorder
 call ZhAbilityTitle
 ret
.packDigits
 push hl
...
.Tiles:
 INCBIN "gfx/zh/summary_labels.2bpp"
...
ZhCenterSummaryStats::
 ld hl,wSummaryScreenWindowBuffer + 8 * 32 - 1
 ld de,wSummaryScreenWindowBuffer + 9 * 32 - 1
 ld bc,6 * 32
.copy
 ld a,[hld]
 ld [de],a
